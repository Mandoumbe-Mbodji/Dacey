...
def send_message():
    ...
    cluster = MongoClient("mongodb+srv://pape1001:1599@cluster0.febcwf1.mongodb.net/?retryWrites=true&w=majority")
db = cluster["asssurema"]
clients = db["users"]
commandes = db["services"]
client = SocketClient('http://ac-emucvks-shard-00-01.febcwf1.mongodb.net:27017/')
